 ...
 */
final class Version20260604134330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, synopsis LONGTEXT NOT NULL, release_date DATETIME NOT NULL, duration TIME NOT NULL, rating DOUBLE PRECISION NOT NULL, type VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, video_url VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
