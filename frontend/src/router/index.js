...
import GenreDeletedView from "@/views/GenreDeletedView.vue";
import GenreListView from "@/views/GenreListView.vue";



// Routes qui ne sont pas en lien avec ApiPaltform
const routes = [
  ...
  { path: "/genres/delete/:id", name: "genresdeleted", component: GenreDeletedView },
];
