...
export const handlers = [
  ...
  //mon api register sur api platform
  ...
  http.post(`${API_URL}/token/refresh`, async ({ request }) => {
    ...
    if (body.refresh_token === "fake-refresh-token") {
      return HttpResponse.json({
        token:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MSwiZW1haWwiOiJ1c2VyQGV4YW1wbGUuY29tIiwicm9sZXMiOlsiUk9MRV9VU0VSIl0sImV4cCI6OTk5OTk5OTk5OX0.newtoken",
